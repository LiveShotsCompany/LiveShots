...
const Matches = () => {
  ...
  return (
    <div className="flex justify-center h-[515px] bg-gray-200 pt-4 pb-4">
      <div className="flex flex-col border-2 border-green-600 p-4 rounded-lg items-center justify-start bg-gray-100">
            <div className="flex justify-center w-96">
              {generateDateButtons()}
            </div>
        <div className="flex flex-col pt-2 overflow-auto scrollbar-thin">
              ...
              return (
                <div className="" key={leagueId}>
                  {matchesForSelectedDate.map((match) => (
                    <Link key={match.id} href={`/${match.id}`}>
