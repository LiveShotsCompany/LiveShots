            ...
            <div className="flex flex-col pt-2 scrollbar-hide overflow-auto">
              <div className="border-2 border-green-600 mb-4">
                ...
                {Object.keys(matchesByLeague).map((leagueId) => {
                  const matchesForSelectedDate = matchesByLeague[
                    leagueId
                  ].filter(
                    (match) =>
                    ...
                    <div className="" key={leagueId}>
                      {matchesForSelectedDate.map((match) => (
                        <Link key={match.id} href={`/matches/${match.id}`}>
                          <ul className="flex items-center bg-green-600 hover:bg-green-500 text-sm border-b-4 border-green-500">
              ...
              {Object.keys(matchesByLeague).map((leagueId) => {
                ...
                return (
                  <div
                    className="mb-4 border-2 border-green-600"
                    key={leagueId}
                  >
